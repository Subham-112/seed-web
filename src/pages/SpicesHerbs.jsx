...
function SpicesHerbs() {
  ...
  const spices = [
    ...
    },
    {
      ...
      img: '../../public/images/turmeric.png'
    },
  ];

  const showComponent = (nm) => {
    setItems((prev) => (
      {...prev, name: nm.name, image: nm.img}
    ));
    setWindow(true);
  };
  ...
  return (
    <>
      {window ? (
        <div className="item-pr-sec">
          <ItemComponent items={items} closeWin={handleCloseWindow} />
        </div>
      ) : (
        <></>
      )}
          ...
          <div className="container">
            ...
            <div className="products-showcase">
              {spices.map((spice, index) => (
                <div
                  onClick={() => showComponent(spice)}
                  key={index}
                  className="product-showcase-card spice-card"
                >
            ...
            <div className="spice-processing">
              ...
              <div className="processing-grid">
                ...
                <div className="processing-step">
                  ...
                  <p>
                    Steam sterilization to eliminate microbial contamination
                  </p>
                </div>
                <div className="processing-step">
